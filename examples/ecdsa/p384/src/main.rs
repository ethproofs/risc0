...
use p384_methods::{P384_VERIFY_ELF, P384_VERIFY_ID};
use rand_core::OsRng;
use risc0_zkvm::{default_prover, ExecutorEnv, Receipt};

/// Given an secp384r1 verifier key (i.e. public key), message and signature,
...
fn prove_ecdsa_verification(
    ...
    prover.prove(env, P384_VERIFY_ELF).unwrap().receipt
}

fn main() {
    // Generate a random secp384r1 keypair and sign the message.
    ...
    receipt.verify(P384_VERIFY_ID).unwrap();
